...
4.  Tap **Manual Setup**.
    - _Note: Always choose Manual Setup to ensure the correct `davnode.me` hostnames are used._
...
4.  **IMAP Server:** Enter `mail.davnode.me`.
...
1.  **SMTP Server:** Enter `mail.davnode.me`.
...
- **Check Spacing:** Ensure no extra spaces exist at the end of `mail.davnode.me` (common with mobile autocorrect).
