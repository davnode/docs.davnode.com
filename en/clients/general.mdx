...
| Setting                   | Value                                            |
| :------------------------ | :----------------------------------------------- |
| **Server Hostname**       | `mail.davnode.me`                                |
| **Port**                  | `993`                                            |
| **Security / Encryption** | SSL / TLS                                        |
| **Username**              | Your full email address (e.g., `you@davnode.me`) |
...
5.  **Input Server Details:** Copy the Hostname (`mail.davnode.me`) and Ports (`993` / `465`) from the reference table above.
...
- If you see a warning about the certificate not matching, ensure the **Server Hostname** is set to `mail.davnode.me`.
